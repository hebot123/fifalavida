        ...
        try {
            ...
            TicketEngine.listings = items
                .filter(item => {
                    ...
                    // 1. Must be a Ticket (contains "Right To Ticket")
                    const isRTT = title.includes("right to ticket");
                    
                    // 2. Must NOT be Club World Cup (removes "Club", "Flamengo", "Pennant", etc)
                    const isClub = title.includes("club") || title.includes("pennant");
                    
                    // 3. Must look like a 2026 Match (M followed by digits) - FIXED REGEX
                    // The 'i' flag makes it Case Insensitive so it matches "M32" and "m32"
                ...
                .map(item => {
                    ...
                    // Extract Match Number (Case Insensitive)
                    ...
                    // Extract City from title (e.g. "... for M32 Seattle")
